...
navbar = dbc.NavbarSimple(
    brand='Climate Temperature Anomalies',
    brand_href='/', 
    children=[
...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Oscar Calzada', className='mr-2'), 
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:oscarcalzada555@gmail.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/ocalzada/ds7-climate-change'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/oscar-calzada-b34b8b53/'), 
                    html.A(html.I(className='fab fa-twitter-square mr-1'), href='https://twitter.com/OscarCa91504788'), 
                ], 
                className='lead'
            )
        )
